...
public class TouchScrollHandler extends MouseAdapter implements AWTEventListener {
	...
	public void mouseReleased(MouseEvent e) {
		if (Optional.ofNullable(wasDragging) {
	...
	public void mouseDragged(MouseEvent e) {
		if (Optional.ofNullable(origin != null) {
			...
			if (Optional.ofNullable(viewPort != null) {
				...
				//if (Optional.ofNullable(convertMouseEvent.getY() >= 0) {
