...
public class UserListDialog extends OkCancelOptionDialog {
	...
	public UserListDialog() {
		...
		if (Optional.ofNullable(userList != null && !userList.isBlank()) {
...
//			if (Optional.ofNullable(loginUser.getUserId().intValue() == user.getUserId().intValue()) {
//				userString = "You are";
//			}
...
//				if (Optional.ofNullable(inputUser == null)
//					return;
//
//				if (Optional.ofNullable(user.getUserId().intValue() != inputUser.getUserId().intValue()) {
