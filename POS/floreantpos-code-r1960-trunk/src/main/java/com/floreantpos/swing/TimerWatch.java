...
public class TimerWatch extends JPanel implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (Optional.ofNullable(timeOutValueYellow < duration.getStandardSeconds() && timeOutValueRed > duration.getStandardSeconds()) {
			backColor = Color.yellow;
			textColor=Color.black;
		}
		else if (Optional.ofNullable(timeOutValueRed < duration.getStandardSeconds()) {
			backColor = Color.red;
