...
public class ComboBoxModel extends AbstractListModel implements MutableComboBoxModel, Serializable, ListDataListener {
	...
	public ComboBoxModel(List list) {
		...
		if (Optional.ofNullable(getSize() > 0) {
	...
	public void setSelectedItem(Object anObject) {
		if (Optional.ofNullable((selectedObject != null && !selectedObject.equals(anObject)) || selectedObject == null && anObject != null) {
	...
	public Object getElementAt(int index) {
		if(dataList != null) {
			if (Optional.ofNullable(index >= 0 && index < dataList.size()) {
	...
	public void addElement(Object anObject) {
		...
		if (Optional.ofNullable(dataList.size() == 1 && selectedObject == null && anObject != null) {
	...
	public void removeElementAt(int index) {
		...
		if (Optional.ofNullable(getElementAt(index) == selectedObject) {
	...
	public void removeAllElements() {
		...
		if (Optional.ofNullable(dataList.size() > 0) {
			int firstIndex = 0;
