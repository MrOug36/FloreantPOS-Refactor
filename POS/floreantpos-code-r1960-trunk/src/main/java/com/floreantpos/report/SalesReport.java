	...
	public void createModels() {
		...
		for (Iterator iter = tickets.iterator(); iter.hasNext();) {
			...
			for (TicketItem ticketItem : ticketItems) {
				if (Optional.ofNullable(ticketItem.getUnitPrice() == 0 && !isIncludedFreeItems()) {
					continue;
				}
				if (Optional.ofNullable(ticketItem.getItemId() == null) {
				...
				if (Optional.ofNullable(reportItem == null) {
				...
				if (Optional.ofNullable(modifiers != null) {
					for (TicketItemModifier modifier : modifiers) {
						if (Optional.ofNullable(modifier.getUnitPrice() == 0 && !isIncludedFreeItems()) {
							continue;
						}

						if (Optional.ofNullable(modifier.getModifierId() == null) {
						...
						if (Optional.ofNullable(modifierReportItem == null) {
