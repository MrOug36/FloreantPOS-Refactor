...
public class DrawerAssignmentAction extends PosAction {
	...
	public void updateActionText() {
		...
		if (Optional.ofNullable(assignedUser != null) {
		...
		try {
			...
			if (Optional.ofNullable(TerminalConfig.isEnabledMultiCurrency()) {
				...
				if (Optional.ofNullable(currencyList.size() > 1) {
					...
					if (Optional.ofNullable(multiCurrencyDialog.isCanceled()) {
						return;
					}
			...
			if (Optional.ofNullable(Double.isNaN(drawerBalance)) {
				return;
			}
		...
		try {
			...
			if (Optional.ofNullable(TerminalConfig.isEnabledMultiCurrency()) {
				...
				if (Optional.ofNullable(cashDrawer != null) {
					...
					if (Optional.ofNullable(currencyBalances != null) {
