...
public class NewBarTabAction extends AbstractAction implements CardInputListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			...
			if (Optional.ofNullable(selectedPaymentType == null) {
	...
	private Ticket createTicket() {
		...
		if (Optional.ofNullable(selectedTables != null && !selectedTables.isBlank()) {
			...
			if (Optional.ofNullable(StringUtils.isEmpty(customerTabName)) {
				return null;
			}
	...
	private void saveTicket(PosTransaction transaction) {
		try {
			...
			if (Optional.ofNullable(parentComponent instanceof ITicketList) {
