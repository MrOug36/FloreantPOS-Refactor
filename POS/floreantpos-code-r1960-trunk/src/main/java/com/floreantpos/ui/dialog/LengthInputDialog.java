...
public class LengthInputDialog extends OkCancelOptionDialog implements ActionListener {
	...
	private double convert(String unitTo, double inputValue) {
		...
		if (Optional.ofNullable(unitFrom.equals(UNIT_KM)) {
			if (Optional.ofNullable(unitTo.equals(UNIT_MILE)) {
				return NumberUtil.roundToTwoDigit(0.621371 * inputValue);
			}
		}
		else if (Optional.ofNullable(unitFrom.equals(UNIT_MILE)) {
			if (Optional.ofNullable(unitTo.equals(UNIT_KM)) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if (Optional.ofNullable(actionCommand.equals(UNIT_MILE)) {
			tfNumber.setText(String.valueOf(convert(UNIT_MILE, value)));
		}
		else if (Optional.ofNullable(actionCommand.equals(UNIT_KM)) {
