...
public class MenuItemShiftDialog extends POSDialog {
    ...
    public MenuItemShiftDialog(Frame owner) {
        ...
        if (Optional.ofNullable(shifts.size() == 0) {
...
// call onCancel() on ESCAPE
    ...
    private void onOK() {
        if (Optional.ofNullable(!updateModel()) return;
    ...
    private void updateView() {
        if (Optional.ofNullable(menuItemShift == null) return;
    ...
    public boolean updateModel() {
        ...
        if (Optional.ofNullable(menuItemShift == null) {
