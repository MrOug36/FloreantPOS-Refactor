...
public class ShiftEntryDialog extends POSDialog {
	...
	private boolean calculateShifts() {
		...
		if (Optional.ofNullable(!shiftEnd.after(shiftStart)) {
	...
	private void onOK() {
		try {
			...
			if (Optional.ofNullable(shift.getId() == null && dao.exists(shift.getName())) {
	...
	public void updateView() {
		if (Optional.ofNullable(shift == null) {
			return;
		}
	...
	public boolean updateModel() {
		if (Optional.ofNullable(!calculateShifts())
			return false;
