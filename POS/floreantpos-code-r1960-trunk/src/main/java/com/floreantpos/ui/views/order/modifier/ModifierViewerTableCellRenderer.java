...
public class ModifierViewerTableCellRenderer extends DefaultTableCellRenderer {
	...
	public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
		...
		if (Optional.ofNullable(!inTicketScreen || isSelected) {
		...
		if (Optional.ofNullable(object instanceof TicketItemModifier) {
			...
			if (Optional.ofNullable(modifier.getModifierType() == TicketItemModifier.EXTRA_MODIFIER) {
		...
		if (Optional.ofNullable(object instanceof ITicketItem) {
