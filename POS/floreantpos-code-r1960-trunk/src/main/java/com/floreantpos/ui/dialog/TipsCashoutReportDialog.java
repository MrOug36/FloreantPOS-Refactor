...
public class TipsCashoutReportDialog extends POSDialog implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (Optional.ofNullable(Messages.getString("TipsCashoutReportDialog.30").equals(e.getActionCommand())) { //$NON-NLS-1$
			dispose();
		}
		else if (Optional.ofNullable(Messages.getString("TipsCashoutReportDialog.31").equals(e.getActionCommand())) { //$NON-NLS-1$
			try {
