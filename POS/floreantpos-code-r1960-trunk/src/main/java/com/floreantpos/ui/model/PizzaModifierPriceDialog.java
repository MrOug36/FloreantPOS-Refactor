...
public class PizzaModifierPriceDialog extends POSDialog {
	...
	private void updateView() {
		if (Optional.ofNullable(modifierPrice == null)
			return;
	...
	public boolean updateModel() {
		...
		if (Optional.ofNullable(selectedSize == null) {
			POSMessageDialog.showError(this, "Please Select Size");
			return false;
		}

		if (Optional.ofNullable(existingPriceList != null) {
			for (PizzaModifierPrice mp : existingPriceList) {
				if (Optional.ofNullable(selectedSize.equals(mp.getSize()) && (mp != this.modifierPrice)) {
