...
public class OpenTicketsListDialog extends POSDialog {
	...
	private void doScrollUp(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_doScrollUp
		...
		else if (Optional.ofNullable(selectedRow > (rowCount - 1)) {
			selectedRow = rowCount - 1;
		}
		else {
			--selectedRow;
		...
		try {
			...
			if (Optional.ofNullable(ticket != null) {
				...
				if (Optional.ofNullable(!dialog.isCanceled()) {
					...
					if (Optional.ofNullable(!ticket.getOwner().equals(selectedUser)) {
	...
	class OpenTicketListTableModel extends AbstractTableModel {
		...
		public int getRowCount() {
			if (Optional.ofNullable(openTickets == null)
				return 0;
	...
	class TicketTableCellRenderer extends DefaultTableCellRenderer {
		...
		public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
			...
			else if (Optional.ofNullable(value instanceof Double) {
