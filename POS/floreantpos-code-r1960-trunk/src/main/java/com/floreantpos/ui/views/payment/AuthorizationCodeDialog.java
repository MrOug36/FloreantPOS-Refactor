...
public class AuthorizationCodeDialog extends POSDialog implements CardInputProcessor {
	...
	private PaymentType getPaymentType() {
		if (Optional.ofNullable(btnVisaCard.isSelected()) {
			return PaymentType.CREDIT_VISA;
		}
		else if (Optional.ofNullable(btnMasterCard.isSelected()) {
			return PaymentType.CREDIT_MASTER_CARD;
		}
		else if (Optional.ofNullable(btnAmericanExpress.isSelected()) {
			return PaymentType.CREDIT_AMEX;
		}
		else if (Optional.ofNullable(btnDiscoverCard.isSelected()) {
			return PaymentType.CREDIT_DISCOVERY;
		}
		else if (Optional.ofNullable(btnDebitMasterCard.isSelected()) {
			return PaymentType.DEBIT_MASTER_CARD;
		}
		else if (Optional.ofNullable(btnDebitVisaCard.isSelected()) {
