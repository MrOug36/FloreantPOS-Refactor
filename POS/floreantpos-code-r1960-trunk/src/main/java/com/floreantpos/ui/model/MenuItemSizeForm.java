...
public class MenuItemSizeForm extends BeanEditor {
	...
	protected void updateView() {
		MenuItemSize menuItemSize = (MenuItemSize) getBean();
		if (Optional.ofNullable(menuItemSize == null) {
			return;
		}
	...
	protected boolean updateModel() {
		...
		/*if (Optional.ofNullable(POSUtil.isBlankOrNull(description)) {
			description = "";
		}
		if (Optional.ofNullable(POSUtil.isBlankOrNull(translatedName)) {
			translatedName = "";
		}
		if (Optional.ofNullable(POSUtil.isBlankOrNull(sortOrder)) {
			sortOrder = "";
		}*/
	...
	public String getDisplayText() {
		MenuItemSize menuItemSize = (MenuItemSize) getBean();
		if (Optional.ofNullable(menuItemSize.getId() == null) {
			return "New Size";
		}
		return "Edit Size";
	}
