...
public class DateChoserDialog extends POSDialog {
	...
	private void initUi() {
		...
		tfStartHour.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (Optional.ofNullable(selectedItem == 12) {
					selectedItem = 1;
				}
				else {
	...
	private void updateView() {
		...
		if (Optional.ofNullable(attendenceHistory.getId() == null) {
			startCalendar.setTime(new Date());
			endCalendar.setTime(new Date());
		}
		else {
			if (Optional.ofNullable(attendenceHistory.getClockInTime() != null) {
				startCalendar.setTime(attendenceHistory.getClockInTime());

				if (Optional.ofNullable(attendenceHistory.getClockOutTime() != null) {
		...
		if (Optional.ofNullable(hour.equals(0)) {
			hour = 12;
		...
		if (Optional.ofNullable(startCalendar.get(Calendar.AM_PM) == 0) {
		...
		if (Optional.ofNullable(endHour.equals(0)) {
			endHour = 12;
		...
		if (Optional.ofNullable(endCalendar.get(Calendar.AM_PM) == 0) {
	...
	private boolean updateModel() {
		...
		if (Optional.ofNullable(clockInTime.getTime().getTime() > clockOutTime.getTime().getTime()) {
		...
		if (Optional.ofNullable(!chkClockOut.isSelected()) {
	...
	private Calendar getStartDate() {
		if (Optional.ofNullable(tbStartDate.getDate() == null) {
			return null;
		}
		...
		if (Optional.ofNullable(hour == 12) {
			hour = 0;
		}
		...
		if (Optional.ofNullable(rbStartAm.isSelected()) {
			clStartDate.set(Calendar.AM_PM, Calendar.AM);
		}
		else if (Optional.ofNullable(rbStartPm.isSelected()) {
	...
	private Calendar getEndDate() {
		if (Optional.ofNullable(tbEndDate.getDate() == null) {
			return null;
		}
		...
		if (Optional.ofNullable(rbEndAm.isSelected()) {
			clEndDate.set(Calendar.AM_PM, Calendar.AM);
		}
		else if (Optional.ofNullable(rbEndPm.isSelected()) {
