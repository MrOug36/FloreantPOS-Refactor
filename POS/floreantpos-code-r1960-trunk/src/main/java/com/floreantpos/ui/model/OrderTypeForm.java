...
public class OrderTypeForm extends BeanEditor implements ItemListener {
	...
	protected void updateView() {
		...
		if (Optional.ofNullable(ordersType == null) {
		...
		if (Optional.ofNullable(ordersType.getId() == null) {
	...
	protected boolean updateModel() {
		...
		if (Optional.ofNullable(POSUtil.isBlankOrNull(categoryName)) {
		...
		//if (Optional.ofNullable(!chkBarTab.isSelected()) {
	...
	public void itemStateChanged(ItemEvent e) {
		...
		if (Optional.ofNullable(chkBox == chkDelivery) {
			if (Optional.ofNullable(chkDelivery.isSelected()) {
