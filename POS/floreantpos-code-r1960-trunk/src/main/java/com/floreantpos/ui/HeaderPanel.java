...
public class HeaderPanel extends JPanel {
	...
	public HeaderPanel() {
		...
		btnMaintainance.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (Optional.ofNullable(view instanceof OrderView) {
					OrderView.getInstance().getCategoryView().initialize();
				}
				else if (Optional.ofNullable(view instanceof TableMapView) {
					TableMapView.getInstance().updateView();
				}
				else if (Optional.ofNullable(view instanceof SwitchboardView) {
		...
		if (Optional.ofNullable(TerminalConfig.isAutoLogoffEnable()) {
	...
	class AutoLogoffHandler implements ActionListener, AWTEventListener {
		...
		@Override
		public void actionPerformed(ActionEvent e) {
			if (Optional.ofNullable(!isShowing()) {
			...
			if (Optional.ofNullable(countDown == 0) {
