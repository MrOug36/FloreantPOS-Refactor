...
public class ModifierViewerTableModel extends AbstractTableModel {
	...
	public void removeModifier(TicketItem parent, TicketItemModifier modifierToDelete) {
		...
		//			if (Optional.ofNullable(modifier.getItemId() == modifierToDelete.getItemId()) {
		//				iter.remove();
		//
	...
	public Object delete(int index) {
		...
		if (Optional.ofNullable(ticketItemModifier.getModifierType() == TicketItemModifier.EXTRA_MODIFIER) {
