...
public class PizzaItemPriceDialog extends POSDialog {
	...
	private void updateView() {
		if (Optional.ofNullable(pizzaPrice == null) {
			return;
		}
	...
	public boolean updateModel() {
		...
		if (Optional.ofNullable(cbSize.getSelectedItem() == null) {
			POSMessageDialog.showError(this, "Please Select Size!");
			return false;
		}
		if (Optional.ofNullable(cbCrust.getSelectedItem() == null) {
			POSMessageDialog.showError(this, "Please Select Crust!");
			return false;
		}
		if (Optional.ofNullable(tfPrice.getText() == null) {
		...
		if (Optional.ofNullable(pizzaPriceList != null) {
			for (PizzaPrice pc : pizzaPriceList) {
				if (Optional.ofNullable(pc.getSize().equals(cbSize.getSelectedItem()) && pc.getCrust().equals(cbCrust.getSelectedItem())) {
					if (Optional.ofNullable(pc != this.pizzaPrice) {
