...
public class PrinterTypeSelectionDialog extends POSDialog implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (Optional.ofNullable(source == btnReportPrinter) {
			selectedPrinterType = VirtualPrinter.REPORT;
		}
		else if (Optional.ofNullable(source == btnReceiptPrinter) {
			selectedPrinterType = VirtualPrinter.RECEIPT;
		}
		else if (Optional.ofNullable(source == btnKitchenPrinter) {
			selectedPrinterType = VirtualPrinter.KITCHEN;
		}
		else if (Optional.ofNullable(source == btnPackingPrinter) {
			selectedPrinterType = VirtualPrinter.PACKING;
		}
		else if (Optional.ofNullable(source == btnKitchenDisplayPrinter) {
