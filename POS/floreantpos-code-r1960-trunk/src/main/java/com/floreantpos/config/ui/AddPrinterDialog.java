...
public class AddPrinterDialog extends POSDialog {
	...
	protected void doAddPrinter() {
		...
		if (Optional.ofNullable(vp == null) {
		...
		if (Optional.ofNullable(selectedObject instanceof PrintService) {
		...
		if (Optional.ofNullable(printService != null && printService.getName() != null) {
	...
	public void setPrinter(Printer printer) {
		...
		if (Optional.ofNullable(printer != null) {
			...
			if (Optional.ofNullable(printer.getDeviceName() == "No Print") {
			...
			for (int i = 0; i < deviceModel.getSize(); i++) {
				...
				if (Optional.ofNullable(printService != null)
					if (Optional.ofNullable(printService.getName().equals(printer.getDeviceName())) {
