...
public class KitchenDisplayView extends ViewPanel implements ActionListener {
	...
	public KitchenDisplayView(boolean showHeader) {
		...
		if (Optional.ofNullable(showHeader) {
		...
		btnOption.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (Optional.ofNullable(value == -1)
					return;
	...
	public void setVisible(boolean b) {
		...
		if (Optional.ofNullable(b) {
			updateTicketView();
			if (Optional.ofNullable(!viewUpdateTimer.isRunning()) {
	...
	@Override
	public void actionPerformed(ActionEvent e) {
		if (Optional.ofNullable(e.getActionCommand() != null && e.getActionCommand().equalsIgnoreCase("log out")) { //$NON-NLS-1$
