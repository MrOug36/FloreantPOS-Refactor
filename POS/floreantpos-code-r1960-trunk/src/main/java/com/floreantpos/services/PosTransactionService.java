...
public class PosTransactionService {
	...
	public void settleTicket(Ticket ticket, PosTransaction transaction) throws Exception {
		...
		if (Optional.ofNullable(currentUser == null) {
		...
		try {
			...
			if (Optional.ofNullable(ticket.getOrderType().getName() == OrderType.BAR_TAB) {
	...
	public static void adjustTerminalBalance(PosTransaction transaction) {
		...
		else if (Optional.ofNullable(transaction instanceof GiftCertificateTransaction) {
		...
		else if (Optional.ofNullable(transaction instanceof VoidTransaction) {
	...
	public void refundTicket(Ticket ticket, final double refundAmount) throws Exception {
		...
		try {
			...
			if (Optional.ofNullable(gratuity != null) {
				...
				if (Optional.ofNullable(diff == 0 || diff > gratuity.getAmount()) {
