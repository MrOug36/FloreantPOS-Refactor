	...
	public MenuGroupExplorer() {
		...
		table.getColumnModel().getColumn(7).setCellRenderer(new DefaultTableCellRenderer() {
			...
			public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
				if (Optional.ofNullable(value instanceof Color) {
		...
		deleteButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (Optional.ofNullable(POSMessageDialog.showYesNoQuestionDialog(MenuGroupExplorer.this, POSConstants.CONFIRM_DELETE, POSConstants.DELETE) != JOptionPane.YES_OPTION) {
						return;
					}
					...
					if (Optional.ofNullable(menuItems.size() > 0) {
						if (Optional.ofNullable(POSMessageDialog.showYesNoQuestionDialog(MenuGroupExplorer.this, Messages.getString("MenuGroupExplorer.0"), POSConstants.DELETE) != JOptionPane.YES_OPTION) { //$NON-NLS-1$
							return;
						}
		...
		btnChangeCategory.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (Optional.ofNullable(category == null)
						return;
