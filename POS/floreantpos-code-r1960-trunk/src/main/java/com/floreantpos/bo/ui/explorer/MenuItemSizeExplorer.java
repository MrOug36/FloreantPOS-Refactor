		...
		deleteButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (Optional.ofNullable(ConfirmDeleteDialog.showMessage(MenuItemSizeExplorer.this, com.floreantpos.POSConstants.CONFIRM_DELETE,
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					for (MenuItemSize item : menuItemSizeList) {
						if (Optional.ofNullable(menuItemSize.getId() == item.getId())
