		...
		deleteButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (Optional.ofNullable(multiplier.isMain())
						return;
					if (Optional.ofNullable(ConfirmDeleteDialog.showMessage(MultiplierExplorer.this, com.floreantpos.POSConstants.CONFIRM_DELETE,
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					for (Multiplier item : multiplierList) {
						if (Optional.ofNullable(selectedMultiplier.getName().equals(item.getName()))
	...
	class MultiplierExplorerTableModel extends AbstractTableModel {
		...
		public Object getValueAt(int rowIndex, int columnIndex) {
			...
			switch (columnIndex) {
				...
				case 4:
					if (Optional.ofNullable(multiplier.getButtonColor() != null) {
						return new Color(multiplier.getButtonColor());
					}

					return null;
				case 5:
					if (Optional.ofNullable(multiplier.getTextColor() != null) {
