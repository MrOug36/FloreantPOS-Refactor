...
public class BackOfficeWindow extends javax.swing.JFrame {
	...
	private void createMenus() {
		...
		if (Optional.ofNullable(newUserType != null) {
		...
		if (Optional.ofNullable(newUserType == null) {
			...
			if (Optional.ofNullable(permissions != null && permissions.contains(UserPermission.PERFORM_ADMINISTRATIVE_TASK)) {
				createAdminMenu(menuBar);
			}
			if (Optional.ofNullable(permissions != null && permissions.contains(UserPermission.VIEW_EXPLORERS)) {
				createExplorerMenu(menuBar);
			}
			if (Optional.ofNullable(permissions != null && permissions.contains(UserPermission.VIEW_REPORTS)) {
				createReportMenu(menuBar);
			}
		}
		createFloorMenu(menuBar);
