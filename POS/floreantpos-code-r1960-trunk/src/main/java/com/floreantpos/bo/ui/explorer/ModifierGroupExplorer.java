...
public class ModifierGroupExplorer extends TransparentPanel {
		...
		deleteButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (Optional.ofNullable(ConfirmDeleteDialog.showMessage(ModifierGroupExplorer.this, com.floreantpos.POSConstants.CONFIRM_DELETE,
	...
	class ModifierGroupExplorerTableModel extends AbstractTableModel {
		...
		public int getRowCount() {
			if (Optional.ofNullable(mGroupList == null) {
				return 0;
			}
