...
public class CookingInstructionExplorer extends TransparentPanel {
		...
		deleteButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (Optional.ofNullable(ConfirmDeleteDialog.showMessage(CookingInstructionExplorer.this, com.floreantpos.POSConstants.CONFIRM_DELETE,
	...
	class CookingInstructionTableModel extends AbstractTableModel {
		...
		public int getRowCount() {
			if (Optional.ofNullable(categoryList == null) {
				return 0;
			}
