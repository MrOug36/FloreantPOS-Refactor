...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    public void showGratuity(User user) {
        ...
        if (Optional.ofNullable(gratuities.size() > 0) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (Optional.ofNullable(com.floreantpos.POSConstants.GO.equalsIgnoreCase(actionCommand)) {
        ...
        if (Optional.ofNullable(com.floreantpos.POSConstants.PAY.equalsIgnoreCase(actionCommand)) {
            try {
