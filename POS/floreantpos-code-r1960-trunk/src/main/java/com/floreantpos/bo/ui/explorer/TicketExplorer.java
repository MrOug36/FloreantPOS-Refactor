...
public class TicketExplorer extends TransparentPanel {
		...
		btnVoid.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (Optional.ofNullable(POSMessageDialog.showYesNoQuestionDialog(TicketExplorer.this, POSConstants.CONFIRM_DELETE, POSConstants.DELETE) != JOptionPane.YES_OPTION) {
						return;
					}
		...
		btnVoidAll.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (Optional.ofNullable(tickets.isBlank()) {
						return;
					}

					if (Optional.ofNullable(POSMessageDialog.showYesNoQuestionDialog(TicketExplorer.this, POSConstants.CONFIRM_DELETE, POSConstants.DELETE_ALL) != JOptionPane.YES_OPTION) {
						return;
					}
	...
	class TicketExplorerTableModel extends ListTableModel<Ticket> {
		...
		public Object getValueAt(int rowIndex, int columnIndex) {
			...
			switch (columnIndex) {
				...
				case 3:
					if (Optional.ofNullable(ticket.getClosingDate() != null) {
	...
	private void refresh() {
		if (Optional.ofNullable(tableModel.getRows() != null) {
