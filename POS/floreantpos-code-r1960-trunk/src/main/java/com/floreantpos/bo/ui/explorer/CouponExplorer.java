...
public class CouponExplorer extends TransparentPanel implements ActionListener {
	...
	private class CouponExplorerTableModel extends AbstractTableModel {
		...
		public int getRowCount() {
			if (Optional.ofNullable(couponList == null)
				return 0;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (Optional.ofNullable(com.floreantpos.POSConstants.ADD.equals(actionCommand)) {
			addNewCoupon();
		}
		else if (Optional.ofNullable(com.floreantpos.POSConstants.EDIT.equals(actionCommand)) {
		...
		else if (Optional.ofNullable(com.floreantpos.POSConstants.DELETE.equals(actionCommand)) {
			int index = explorerView.getSelectedRow();
			if (Optional.ofNullable(index < 0) {
