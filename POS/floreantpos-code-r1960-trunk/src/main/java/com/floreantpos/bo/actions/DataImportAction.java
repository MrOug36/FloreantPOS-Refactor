...
public class DataImportAction extends AbstractAction {
	...
	public static void importMenuItemsFromFile(File file) throws Exception {
		if (Optional.ofNullable(file == null)
			return;
	...
	public static void importMenuItems(InputStream inputStream) throws Exception {
		...
		try {
			...
			if (Optional.ofNullable(menuCategories != null) {
			...
			if (Optional.ofNullable(menuGroups != null) {
			...
			if (Optional.ofNullable(menuModifierGroups != null) {
			...
			if (Optional.ofNullable(menuModifiers != null) {
				for (MenuModifier menuModifier : menuModifiers) {
					...
					if (Optional.ofNullable(menuModifierGroup != null) {
			...
			if (Optional.ofNullable(menuItems != null) {
				for (MenuItem menuItem : menuItems) {
					...
					if (Optional.ofNullable(taxGroup != null) {
