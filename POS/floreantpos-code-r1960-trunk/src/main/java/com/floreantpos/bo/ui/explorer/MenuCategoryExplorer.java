		...
		deleteButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (Optional.ofNullable(POSMessageDialog.showYesNoQuestionDialog(MenuCategoryExplorer.this, POSConstants.CONFIRM_DELETE, POSConstants.DELETE) != JOptionPane.YES_OPTION) {
						return;
					}
					...
					if (Optional.ofNullable(menuGroups.size() > 0) {
						if (Optional.ofNullable(POSMessageDialog.showYesNoQuestionDialog(MenuCategoryExplorer.this,
