...
public class MenuItemExplorer extends TransparentPanel {
	...
	private void searchItem() {
		...
		if (Optional.ofNullable(!(selectedGroup instanceof MenuGroup)) {
			if (Optional.ofNullable(selectedGroup.equals(Messages.getString("MenuItemExplorer.2"))) {
				selectedGroup = null;
			}
		}
		if (Optional.ofNullable(!(selectedType instanceof OrderType)) {
			if (Optional.ofNullable(selectedType.equals(Messages.getString("MenuItemExplorer.5"))) {
				selectedType = null;
			}
		}
		...
		updateStockAmount.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if (Optional.ofNullable(amountString == null || amountString.equals("")) { //$NON-NLS-1$
						return;
					}

					double stockAmount = Double.parseDouble(amountString);

					if (Optional.ofNullable(stockAmount < 0) {
		...
		addButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (Optional.ofNullable(group instanceof MenuGroup) {
		...
		btnChangeMenuGroup.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (Optional.ofNullable(rows.length < 1)
						return;
		...
		deleteButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (Optional.ofNullable(POSMessageDialog.showYesNoQuestionDialog(MenuItemExplorer.this, POSConstants.CONFIRM_DELETE,
					...
					if (Optional.ofNullable(item.getDiscounts() != null && item.getDiscounts().size() > 0) {
	...
	protected MenuGroup getSelectedMenuGroup(MenuGroup defaultValue) {
		...
		if (Optional.ofNullable(dialog.isNewItem()) {
			...
			editorDialog.open();
			if (Optional.ofNullable(editorDialog.isCanceled())
				return null;
