		...
		deleteButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (Optional.ofNullable(ConfirmDeleteDialog.showMessage(PizzaModifierExplorer.this, com.floreantpos.POSConstants.CONFIRM_DELETE,
		...
		duplicateButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (Optional.ofNullable(pizzaModifierPriceList != null) {
	...
	private JPanel buildSearchForm() {
		...
		searchBttn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (Optional.ofNullable(selectedItem instanceof ModifierGroup) {
	...
	private class PizzaModifierExplorerModel extends ListTableModel {
		...
		public Object getValueAt(int rowIndex, int columnIndex) {
			...
			switch (columnIndex) {
				...
				case 4:
					if (Optional.ofNullable(modifier.getModifierGroup() == null) {
						return ""; //$NON-NLS-1$
					}
