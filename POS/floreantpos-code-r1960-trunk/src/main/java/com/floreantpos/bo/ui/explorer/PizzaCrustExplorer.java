		...
		deleteButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (Optional.ofNullable(ConfirmDeleteDialog.showMessage(PizzaCrustExplorer.this, com.floreantpos.POSConstants.CONFIRM_DELETE,
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					for (PizzaCrust item : pizzaCrustList) {
						if (Optional.ofNullable(pizzaCrust.getId() == item.getId())
