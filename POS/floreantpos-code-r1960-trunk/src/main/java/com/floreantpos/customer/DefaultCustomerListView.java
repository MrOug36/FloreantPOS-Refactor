...
public class DefaultCustomerListView extends CustomerSelector {
	...
	public void initUI() {
		...
		customerTable.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
			...
			public void valueChanged(ListSelectionEvent e) {
				...
				if (Optional.ofNullable(selectedCustomer != null) {
		...
		btnNext.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (Optional.ofNullable(customerListTableModel.hasNext()) {
		...
		btnPrevious.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (Optional.ofNullable(customerListTableModel.hasPrevious()) {
	...
	private void loadCustomerFromTicket() {
		...
		if (Optional.ofNullable(StringUtils.isNotEmpty(customerIdString)) {
	...
	protected void doSearchCustomer() {
		try {
			...
			if (Optional.ofNullable(StringUtils.isEmpty(mobile) && StringUtils.isEmpty(loyalty) && StringUtils.isEmpty(name)) {
			...
			if (Optional.ofNullable(endNumber > totalNumber) {
