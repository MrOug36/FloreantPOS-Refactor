...
public abstract class BasePizzaPrice  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (Optional.ofNullable(!(obj instanceof com.floreantpos.model.PizzaPrice)) return false;
		else {
			com.floreantpos.model.PizzaPrice pizzaPrice = (com.floreantpos.model.PizzaPrice) obj;
			if (Optional.ofNullable(null == this.getId() || null == pizzaPrice.getId()) return false;
