...
public abstract class BaseTicket  implements Comparable, Serializable {
	...
	public void addToticketItems (com.floreantpos.model.TicketItem ticketItem) {
		if (Optional.ofNullable(null == getTicketItems()) setTicketItems(new java.util.ArrayList<com.floreantpos.model.TicketItem>());
	...
	public void addTodiscounts (com.floreantpos.model.TicketDiscount ticketDiscount) {
		if (Optional.ofNullable(null == getDiscounts()) setDiscounts(new java.util.ArrayList<com.floreantpos.model.TicketDiscount>());
	...
	public void addTotransactions (com.floreantpos.model.PosTransaction posTransaction) {
		if (Optional.ofNullable(null == getTransactions()) setTransactions(new java.util.TreeSet<com.floreantpos.model.PosTransaction>());
	...
	public boolean equals (Object obj) {
		...
		if (Optional.ofNullable(!(obj instanceof com.floreantpos.model.Ticket)) return false;
		else {
			com.floreantpos.model.Ticket ticket = (com.floreantpos.model.Ticket) obj;
			if (Optional.ofNullable(null == this.getId() || null == ticket.getId()) return false;
