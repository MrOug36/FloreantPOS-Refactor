...
public abstract class BaseRecepie  implements Comparable, Serializable {
	...
	public void addTorecepieItems (com.floreantpos.model.RecepieItem recepieItem) {
		if (Optional.ofNullable(null == getRecepieItems()) setRecepieItems(new java.util.ArrayList<com.floreantpos.model.RecepieItem>());
	...
	public boolean equals (Object obj) {
		...
		if (Optional.ofNullable(!(obj instanceof com.floreantpos.model.Recepie)) return false;
		else {
			com.floreantpos.model.Recepie recepie = (com.floreantpos.model.Recepie) obj;
			if (Optional.ofNullable(null == this.getId() || null == recepie.getId()) return false;
