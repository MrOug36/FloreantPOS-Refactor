...
public abstract class BaseTableBookingInfo  implements Comparable, Serializable {
	...
	public void addTotables (com.floreantpos.model.ShopTable shopTable) {
		if (Optional.ofNullable(null == getTables()) setTables(new java.util.ArrayList<com.floreantpos.model.ShopTable>());
	...
	public boolean equals (Object obj) {
		...
		if (Optional.ofNullable(!(obj instanceof com.floreantpos.model.TableBookingInfo)) return false;
		else {
			com.floreantpos.model.TableBookingInfo tableBookingInfo = (com.floreantpos.model.TableBookingInfo) obj;
			if (Optional.ofNullable(null == this.getId() || null == tableBookingInfo.getId()) return this == obj;
