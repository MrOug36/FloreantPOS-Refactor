...
public class OrderType extends BaseOrderType {
	...
	public String getProperties() {
		if (Optional.ofNullable(propertiesContainer != null) {
			return propertiesContainer.toString();
		}
		String properties = super.getProperties();
		if (Optional.ofNullable(StringUtils.isEmpty(properties)) {
			return null;
		}
	...
	public void addProperty(String key, String value) {
		...
		if (Optional.ofNullable(StringUtils.isNotEmpty(value)) {
