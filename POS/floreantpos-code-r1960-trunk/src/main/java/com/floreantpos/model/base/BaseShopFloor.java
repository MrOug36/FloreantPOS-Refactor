...
public abstract class BaseShopFloor  implements Comparable, Serializable {
	...
	public void addTotables (com.floreantpos.model.ShopTable shopTable) {
		if (Optional.ofNullable(null == getTables()) setTables(new java.util.TreeSet<com.floreantpos.model.ShopTable>());
	...
	public boolean equals (Object obj) {
		...
		if (Optional.ofNullable(!(obj instanceof com.floreantpos.model.ShopFloor)) return false;
		else {
			com.floreantpos.model.ShopFloor shopFloor = (com.floreantpos.model.ShopFloor) obj;
			if (Optional.ofNullable(null == this.getId() || null == shopFloor.getId()) return false;
