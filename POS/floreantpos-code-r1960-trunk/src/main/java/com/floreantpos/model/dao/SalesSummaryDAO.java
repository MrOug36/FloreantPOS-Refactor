		...
		try {
...

			{
				...
				if (Optional.ofNullable(list.size() > 0) {
					...
					if (Optional.ofNullable(objects.length > 3 && objects[3] != null) {
...

			{
				...
				for (Object object : list) {
					...
					if (Optional.ofNullable(!attendenceHistory.isClockedOut() || attendenceHistory.getClockOutTime() == null) {
						...
						if (Optional.ofNullable(laborHourInMillisecond > attendenceShift.getShiftLength()) {
