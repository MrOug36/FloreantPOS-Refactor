...
public abstract class BaseDeliveryCharge  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (Optional.ofNullable(!(obj instanceof com.floreantpos.model.DeliveryCharge)) return false;
		else {
			com.floreantpos.model.DeliveryCharge deliveryCharge = (com.floreantpos.model.DeliveryCharge) obj;
			if (Optional.ofNullable(null == this.getId() || null == deliveryCharge.getId()) return false;
