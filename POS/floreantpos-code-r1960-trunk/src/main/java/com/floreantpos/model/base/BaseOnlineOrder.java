...
public abstract class BaseOnlineOrder  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (Optional.ofNullable(!(obj instanceof com.floreantpos.model.OnlineOrder)) return false;
		else {
			com.floreantpos.model.OnlineOrder orderHistory = (com.floreantpos.model.OnlineOrder) obj;
			if (Optional.ofNullable(null == this.getId() || null == orderHistory.getId()) return this == obj;
