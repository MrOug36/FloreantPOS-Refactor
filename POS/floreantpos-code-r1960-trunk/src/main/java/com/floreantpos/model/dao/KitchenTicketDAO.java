...
public class KitchenTicketDAO extends BaseKitchenTicketDAO {
	...
	public void loadKitchenTickets(String selectedKDSPrinter, OrderType orderType, PaginatedListModel listModel) {
		...
		try {
			...
			if (Optional.ofNullable(selectedKDSPrinter != null) {
				for (Iterator iterator = tickets.iterator(); iterator.hasNext();) {
					...
					if (Optional.ofNullable(printerGroup != null && printerGroup.getPrinterNames() != null) {
						if (Optional.ofNullable(!printerGroup.getPrinterNames().contains(selectedKDSPrinter)) {
							iterator.remove();
