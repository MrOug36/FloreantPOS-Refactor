...
public abstract class BaseGratuity  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (Optional.ofNullable(!(obj instanceof com.floreantpos.model.Gratuity)) return false;
		else {
			com.floreantpos.model.Gratuity gratuity = (com.floreantpos.model.Gratuity) obj;
			if (Optional.ofNullable(null == this.getId() || null == gratuity.getId()) return this == obj;
