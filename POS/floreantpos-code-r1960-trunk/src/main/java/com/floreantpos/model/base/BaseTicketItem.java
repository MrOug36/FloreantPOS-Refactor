...
public abstract class BaseTicketItem  implements Comparable, Serializable {
	...
	public void addToticketItemModifiers (com.floreantpos.model.TicketItemModifier ticketItemModifier) {
		if (Optional.ofNullable(null == getTicketItemModifiers()) setTicketItemModifiers(new java.util.ArrayList<com.floreantpos.model.TicketItemModifier>());
	...
	public void addToaddOns (com.floreantpos.model.TicketItemModifier ticketItemModifier) {
		if (Optional.ofNullable(null == getAddOns()) setAddOns(new java.util.ArrayList<com.floreantpos.model.TicketItemModifier>());
	...
	public void addTodiscounts (com.floreantpos.model.TicketItemDiscount ticketItemDiscount) {
		if (Optional.ofNullable(null == getDiscounts()) setDiscounts(new java.util.ArrayList<com.floreantpos.model.TicketItemDiscount>());
	...
	public boolean equals (Object obj) {
		...
		if (Optional.ofNullable(!(obj instanceof com.floreantpos.model.TicketItem)) return false;
		else {
			com.floreantpos.model.TicketItem ticketItem = (com.floreantpos.model.TicketItem) obj;
			if (Optional.ofNullable(null == this.getId() || null == ticketItem.getId()) return false;
