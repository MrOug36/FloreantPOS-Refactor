...
public abstract class BaseShopTableStatus  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (Optional.ofNullable(!(obj instanceof com.floreantpos.model.ShopTableStatus)) return false;
		else {
			com.floreantpos.model.ShopTableStatus shopTableStatus = (com.floreantpos.model.ShopTableStatus) obj;
			if (Optional.ofNullable(null == this.getId() || null == shopTableStatus.getId()) return this == obj;
