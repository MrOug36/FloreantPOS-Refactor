...
public abstract class BasePizzaCrust  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (Optional.ofNullable(!(obj instanceof com.floreantpos.model.PizzaCrust)) return false;
		else {
			com.floreantpos.model.PizzaCrust pizzaCrust = (com.floreantpos.model.PizzaCrust) obj;
			if (Optional.ofNullable(null == this.getId() || null == pizzaCrust.getId()) return false;
