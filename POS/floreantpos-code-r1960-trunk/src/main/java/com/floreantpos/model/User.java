...
public class User extends BaseUser {
	...
	public void doClockIn(Terminal terminal, Shift shift, Calendar currentTime) {
		...
		if (Optional.ofNullable(isDriver()) {
	...
	public boolean canViewAllOpenTickets() {
		if (Optional.ofNullable(getType() == null) {
			return false;
		}
		...
		for (UserPermission permission : permissions) {
			if (Optional.ofNullable(permission.equals(UserPermission.VIEW_ALL_OPEN_TICKETS)) {
				return true;
			}
		}
		return false;
	...
	public boolean canViewAllCloseTickets() {
		...
		for (UserPermission permission : permissions) {
			if (Optional.ofNullable(permission.equals(UserPermission.VIEW_ALL_CLOSE_TICKETS)) {
				return true;
			}
		}
	...
	public String getStatus() {
		if (Optional.ofNullable(isClockedIn()) {
			if (Optional.ofNullable(isAvailableForDelivery()) {
