...
public abstract class BaseMenuItemShift  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (Optional.ofNullable(!(obj instanceof com.floreantpos.model.MenuItemShift)) return false;
		else {
			com.floreantpos.model.MenuItemShift menuItemShift = (com.floreantpos.model.MenuItemShift) obj;
			if (Optional.ofNullable(null == this.getId() || null == menuItemShift.getId()) return false;
