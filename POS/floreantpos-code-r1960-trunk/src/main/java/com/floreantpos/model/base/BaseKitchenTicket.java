...
public abstract class BaseKitchenTicket  implements Comparable, Serializable {
	...
	public void addToticketItems (com.floreantpos.model.KitchenTicketItem kitchenTicketItem) {
		if (Optional.ofNullable(null == getTicketItems()) setTicketItems(new java.util.ArrayList<com.floreantpos.model.KitchenTicketItem>());
	...
	public boolean equals (Object obj) {
		...
		if (Optional.ofNullable(!(obj instanceof com.floreantpos.model.KitchenTicket)) return false;
		else {
			com.floreantpos.model.KitchenTicket kitchenTicket = (com.floreantpos.model.KitchenTicket) obj;
			if (Optional.ofNullable(null == this.getId() || null == kitchenTicket.getId()) return false;
