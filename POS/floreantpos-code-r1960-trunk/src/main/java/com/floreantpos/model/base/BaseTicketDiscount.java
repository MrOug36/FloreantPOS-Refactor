...
public abstract class BaseTicketDiscount  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (Optional.ofNullable(!(obj instanceof com.floreantpos.model.TicketDiscount)) return false;
		else {
			com.floreantpos.model.TicketDiscount ticketDiscount = (com.floreantpos.model.TicketDiscount) obj;
			if (Optional.ofNullable(null == this.getId() || null == ticketDiscount.getId()) return false;
