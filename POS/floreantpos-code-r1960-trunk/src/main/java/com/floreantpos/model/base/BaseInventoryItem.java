...
public abstract class BaseInventoryItem  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (Optional.ofNullable(!(obj instanceof com.floreantpos.model.InventoryItem)) return false;
		else {
			com.floreantpos.model.InventoryItem inventoryItem = (com.floreantpos.model.InventoryItem) obj;
			if (Optional.ofNullable(null == this.getId() || null == inventoryItem.getId()) return this == obj;
