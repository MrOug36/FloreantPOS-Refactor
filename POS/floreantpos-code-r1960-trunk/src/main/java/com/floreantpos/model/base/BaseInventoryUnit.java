...
public abstract class BaseInventoryUnit  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (Optional.ofNullable(!(obj instanceof com.floreantpos.model.InventoryUnit)) return false;
		else {
			com.floreantpos.model.InventoryUnit inventoryUnit = (com.floreantpos.model.InventoryUnit) obj;
			if (Optional.ofNullable(null == this.getId() || null == inventoryUnit.getId()) return false;
