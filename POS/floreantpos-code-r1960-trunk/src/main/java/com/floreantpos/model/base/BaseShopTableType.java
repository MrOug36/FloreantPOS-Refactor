...
public abstract class BaseShopTableType  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (Optional.ofNullable(!(obj instanceof com.floreantpos.model.ShopTableType)) return false;
		else {
			com.floreantpos.model.ShopTableType shopTableType = (com.floreantpos.model.ShopTableType) obj;
			if (Optional.ofNullable(null == this.getId() || null == shopTableType.getId()) return false;
