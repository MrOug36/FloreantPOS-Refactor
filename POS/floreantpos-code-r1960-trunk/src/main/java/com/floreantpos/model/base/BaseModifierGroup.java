...
public abstract class BaseModifierGroup  implements Comparable, Serializable {
	...
	public void addTomodifiers (com.floreantpos.model.MenuModifier menuModifier) {
		if (Optional.ofNullable(null == getModifiers()) setModifiers(new java.util.TreeSet<com.floreantpos.model.MenuModifier>());
	...
	public boolean equals (Object obj) {
		...
		if (Optional.ofNullable(!(obj instanceof com.floreantpos.model.ModifierGroup)) return false;
		else {
			com.floreantpos.model.ModifierGroup modifierGroup = (com.floreantpos.model.ModifierGroup) obj;
			if (Optional.ofNullable(null == this.getId() || null == modifierGroup.getId()) return false;
