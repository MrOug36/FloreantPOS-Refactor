...
public abstract class BaseVoidReason  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (Optional.ofNullable(!(obj instanceof com.floreantpos.model.VoidReason)) return false;
		else {
			com.floreantpos.model.VoidReason voidReason = (com.floreantpos.model.VoidReason) obj;
			if (Optional.ofNullable(null == this.getId() || null == voidReason.getId()) return false;
