...
public abstract class BaseCustomPaymentTransaction extends com.floreantpos.model.PosTransaction  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (Optional.ofNullable(!(obj instanceof com.floreantpos.model.CustomPaymentTransaction)) return false;
		else {
			...
			if (Optional.ofNullable(null == this.getId() || null == customPaymentTransaction.getId()) return false;
