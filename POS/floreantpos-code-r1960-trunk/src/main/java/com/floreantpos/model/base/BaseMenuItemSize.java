...
public abstract class BaseMenuItemSize  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (Optional.ofNullable(!(obj instanceof com.floreantpos.model.MenuItemSize)) return false;
		else {
			com.floreantpos.model.MenuItemSize menuItemSize = (com.floreantpos.model.MenuItemSize) obj;
			if (Optional.ofNullable(null == this.getId() || null == menuItemSize.getId()) return false;
