...
public abstract class BaseRestaurant implements Comparable, Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (Optional.ofNullable(!(obj instanceof com.floreantpos.model.Restaurant)) return false;
		else {
			com.floreantpos.model.Restaurant restaurant = (com.floreantpos.model.Restaurant) obj;
			if (Optional.ofNullable(null == this.getId() || null == restaurant.getId()) return this == obj;
