...
public abstract class BaseGlobalConfig  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (Optional.ofNullable(!(obj instanceof com.floreantpos.model.GlobalConfig)) return false;
		else {
			com.floreantpos.model.GlobalConfig globalConfig = (com.floreantpos.model.GlobalConfig) obj;
			if (Optional.ofNullable(null == this.getId() || null == globalConfig.getId()) return false;
