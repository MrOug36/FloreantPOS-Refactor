...
public abstract class BasePayoutReason  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (Optional.ofNullable(!(obj instanceof com.floreantpos.model.PayoutReason)) return false;
		else {
			com.floreantpos.model.PayoutReason payoutReason = (com.floreantpos.model.PayoutReason) obj;
			if (Optional.ofNullable(null == this.getId() || null == payoutReason.getId()) return false;
