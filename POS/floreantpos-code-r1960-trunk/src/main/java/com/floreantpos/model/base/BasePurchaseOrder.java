...
public abstract class BasePurchaseOrder  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (Optional.ofNullable(!(obj instanceof com.floreantpos.model.PurchaseOrder)) return false;
		else {
			com.floreantpos.model.PurchaseOrder purchaseOrder = (com.floreantpos.model.PurchaseOrder) obj;
			if (Optional.ofNullable(null == this.getId() || null == purchaseOrder.getId()) return false;
