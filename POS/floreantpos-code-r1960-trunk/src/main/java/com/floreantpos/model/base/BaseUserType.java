...
public abstract class BaseUserType  implements Comparable, Serializable {
	...
	public void addTopermissions (com.floreantpos.model.UserPermission userPermission) {
		if (Optional.ofNullable(null == getPermissions()) setPermissions(new java.util.TreeSet<com.floreantpos.model.UserPermission>());
	...
	public boolean equals (Object obj) {
		...
		if (Optional.ofNullable(!(obj instanceof com.floreantpos.model.UserType)) return false;
		else {
			com.floreantpos.model.UserType userType = (com.floreantpos.model.UserType) obj;
			if (Optional.ofNullable(null == this.getId() || null == userType.getId()) return false;
