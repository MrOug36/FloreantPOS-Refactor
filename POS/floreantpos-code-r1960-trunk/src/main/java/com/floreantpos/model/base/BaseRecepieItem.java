...
public abstract class BaseRecepieItem  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (Optional.ofNullable(!(obj instanceof com.floreantpos.model.RecepieItem)) return false;
		else {
			com.floreantpos.model.RecepieItem recepieItem = (com.floreantpos.model.RecepieItem) obj;
			if (Optional.ofNullable(null == this.getId() || null == recepieItem.getId()) return false;
