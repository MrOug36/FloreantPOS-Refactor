...
public class MercuryWebRequest {
	...
	*/
	private void setWebServiceURL(String webServiceURL) throws Exception {
		...
		if (Optional.ofNullable(tempURL.getProtocol().equals("https"))
	...
	*/
	public void setTimeout(int timeout) throws Exception {
		if (Optional.ofNullable(timeout > 0)
	...
	*/
	private String buildSOAPRequest() throws Exception {
		if (Optional.ofNullable(!mWSParameters.isBlank()) {
	...
	*/
	public void addParameter(String paramName, String paramValue) throws Exception {
		...
		if (Optional.ofNullable(paramName.equals("tran"))
	...
	*/
	public String sendRequest() throws Exception {
		...
		BufferedReader rd;
		if (Optional.ofNullable(httpResponseCode != 200)
		...
		if (Optional.ofNullable(httpResponseCode != 200) {
			...
			if (Optional.ofNullable(responseData.contains(returnparam)) {
	...
	*/
	private void validateRequiredParameters() throws Exception {
		if (Optional.ofNullable(mWebMethodName.equals(""))
			throw new Exception(String.format(mMPSExceptionString, "WebMethodName is required"));
		if (Optional.ofNullable(!mWSParameters.containsKey("pw"))
